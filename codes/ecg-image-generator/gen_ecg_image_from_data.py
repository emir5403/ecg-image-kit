...
def run_single_file(args):
        ...
        def save_distortion_step(path, suffix, json_dict=None):
            ...
            step_path = f"{base}{suffix}{ext}"
            shutil.copy2(path, step_path)
            if args.store_config and json_dict is not None:
                step_json_path = f"{base}{suffix}.json"
        ...
        for out in out_array:
            if args.store_config:
                ...
                json_dict = None
            save_distortion_step(out, "_step0_distortionless", json_dict)
            ...
            if(hw_text):
                ...
                save_distortion_step(out, "_step1_hw_text", json_dict)
            else:
                num_words = 0
                x_offset = 0
                y_offset = 0
            ...
            if(wrinkles):
                ...
                save_distortion_step(out, "_step2_wrinkles", json_dict)
            else:
                crease_angle = 0
            ...
            if(augment):
                ...
                save_distortion_step(out, "_step3_augment", json_dict)
